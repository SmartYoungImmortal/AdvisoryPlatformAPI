...
Current as of 2026-08-12. Use `git status` for the working-tree state and [`dev-log.md`](./dev-log.md)
...
- Own-profile/avatar, PDPA deletion, public advisor discovery, and Admin advisor listing are not
  implemented. They require audience-specific response DTOs.
